    ...
    <div class="contain">
        ...
        <div class="left_nav">
            <ul class="menu_list">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/medSellPageServlet?account=${user.account}" target="inner_manage_page" >药品销售</a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/medApplyPageServlet?account=${user.account}" target="inner_manage_page">药品申请</a>
                </li>               
                <li>
                    <a href="${pageContext.request.contextPath}/inveQueryPageServlet?account=${user.account}" target="inner_manage_page">库存查询</a>
                </li>                
                <li>
