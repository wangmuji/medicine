    ...
    <div class="contain">
        <div class="top_information">
            <div class="welcome_sentence">
                ...
                <span style="font-size: 20px;padding-top:5%;float:right;padding-right: 20px;">当前用户为总店管理员：${user.username}</span>
            </div>
        </div>
        <div class="left_nav">
            <ul class="menu_list">
            	<li>
                    <a href="${pageContext.request.contextPath}/userManagePageServlet" target="inner_manage_page">分店管理</a><br/>                    
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/medDistrCarServlet" target="inner_manage_page">药品分发</a>
                </li>
                
                <li>
                    <a href="${pageContext.request.contextPath}/medPurchasePageServlet" target="inner_manage_page">购入药品</a>
                </li>
                <li>
