    ...
    <div class="contain">
        <div class="top_information">
            <div class="welcome_sentence">
                <span style="font-size: 25px;float: left;padding-top: 2%;padding-left: 25px;">欢迎使用药店管理系统（前台）</span>
        ...
        <div class="left_nav">
            <ul class="menu_list">
                <li>
                    <a href="${pageContext.request.contextPath}/medSellPageServlet" target="inner_manage_page" >药品销售</a>
                </li>
                <li>
