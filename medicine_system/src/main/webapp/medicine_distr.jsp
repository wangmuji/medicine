    ...
    <body>
        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="medDistributionServlet?account=${branchManager.account }&pageIndex=${page.pageIndex} "><button>分发</button></a></td>
                </tr>
                </c:forEach>     
            </tbody>
        </table>
        <div id="navigate">
                ...
                <div id="tpbt">
                	...
                	<c:if test="${page.pageIndex>1  }">
                		<a href="${pageContext.request.contextPath}/medDistrCarServlet?pageIndex=${page.pageIndex-1}"><button class="gre" id="lastpage">上一页</button></a>
                    ...
                    <c:if test="${page.pageIndex < page.totalPages }">
                    <a href="${pageContext.request.contextPath}/medDistrCarServlet?pageIndex=${page.pageIndex+1}"><button class="red" id="nextpage">下一页</button></a>
            		</c:if>
            </div>
        </div>
